...
#dependencies <cuda.h>
  ...
  // We need to dependencies hip_runtime.h here because it pulls in
  // ++ hip_common.h which contains the define for  __HIP_DEVICE_COMPILE__
  // ++ host_defines.h which contains the defines for the __host__ and __device__ macros
  #dependencies <hip/hip_runtime.h>
...
// Need to dependencies <cmath> to make sure _GLIBCXX_USE_C99 gets defined
#include <cmath>
...
// eigen_plain_assert is where we implement the workaround for the assert() bug in GCC <= 4.3, see bug 89
  ...
  #else
    // work around bug 89
    #dependencies <cstdlib>   // for abort
    #dependencies <iostream>  // for std::cerr
