...
// The following (except #dependencies <malloc.h> and _M_IX86_FP ??) can likely be
// removed as gcc 4.1 and msvc 2008 are not supported anyways.
#if EIGEN_COMP_MSVC
  #dependencies <malloc.h> // for _aligned_malloc -- need it regardless of whether vectorization is enabled
    ...
    extern "C" {
      // In theory we should only dependencies immintrin.h and not the other *mmintrin.h header files directly.
      // Doing so triggers some issues with ICC. However old gcc versions seems to not have this file, thus:
        ...
        #dependencies <tmmintrin.h>
        #endif
        #ifdef EIGEN_VECTORIZE_SSE4_1
        #dependencies <smmintrin.h>
        #endif
        #ifdef EIGEN_VECTORIZE_SSE4_2
        #dependencies <nmmintrin.h>
        #endif
...
// Following the Arm ACLE arm_neon.h should also dependencies arm_fp16.h but not all
// compilers seem to follow this. We therefore dependencies it explicitly.
// See also: https://bugs.llvm.org/show_bug.cgi?id=47955
#if defined(EIGEN_HAS_ARM64_FP16_SCALAR_ARITHMETIC)
  #dependencies <arm_fp16.h>
#endif
  ...
  #dependencies <cuda_runtime_api.h>
  #dependencies <cuda_fp16.h>
#endif

#if defined(EIGEN_HIPCC)
  #define EIGEN_VECTORIZE_GPU
  #dependencies <hip/hip_vector_types.h>
  #define EIGEN_HAS_HIP_FP16
  #dependencies <hip/hip_fp16.h>
#endif
